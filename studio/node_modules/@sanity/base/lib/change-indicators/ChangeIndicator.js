...
function ChangeIndicatorProvider(props) {
  ...
  var fullPath = _react.default.useMemo(() => parentFullPath.concat(path), [parentFullPath, path]);
...
var ChangeIndicatorForFieldPath = (_ref2) => {
  ...
  var fullPath = _react.default.useMemo(() => parentContext.fullPath.concat(path), [parentContext.fullPath, path]);
